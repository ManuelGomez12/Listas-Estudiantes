...
struct nodo{ //Inicio del nodo 
	string numseg;      //Variable y su tipo de dato
	string nombre;      //Variable y su tipo de dato
	int edad;           //Variable y su tipo de dato
	string direccion;   //Variable y su tipo de dato
	char sexo;          //Variable y su tipo de dato
	string fecha; 
	string enfermedad;
	nodo *siguiente;    //Apuntar al siguiente elemento 
}; //Finaliza nodo func
//Declaracion de funciones
//Las funciones no devuelven valores.
...
int main(){ //Inicio de clase principal 
	nodo *lista=NULL;
	string numseg;
	string nombre;
	int edad,opc,a,h;
